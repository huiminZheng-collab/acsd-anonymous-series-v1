...
def CapabilityEstablished (pec : PEC) : Outcome → Prop
  ...
  | .externallyNotAfter => ExternalTimeValid pec.timeEvidence
...
theorem external_time_requires_exact_subject {pec : PEC}
    (h : Granted pec .externallyNotAfter) : pec.timeEvidence.exactSubject = true := h.2.2.1

theorem external_time_requires_signer_pin {pec : PEC}
    (h : Granted pec .externallyNotAfter) : pec.timeEvidence.trustedSignerPin = true := h.2.2.2.1

theorem external_time_requires_nonce {pec : PEC}
    (h : Granted pec .externallyNotAfter) : pec.timeEvidence.nonceMatches = true := h.2.2.2.2.1

theorem external_time_requires_profile {pec : PEC}
    (h : Granted pec .externallyNotAfter) : pec.timeEvidence.profileValid = true := h.2.2.2.2.2.1

theorem external_time_is_not_local_test {pec : PEC}
    (h : Granted pec .externallyNotAfter) : pec.timeEvidence.isLocalTest = false := h.2.2.2.2.2.2
