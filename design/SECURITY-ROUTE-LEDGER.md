...
| Precommit a disjoint recovery key set and threshold, then require its quorum over one exact authority-changing transition plus normal child approval | Restores conditional liveness without granting unspecified future bytes or inventing a post-hoc authority | TUF offline-threshold rotation family; RFC 9580 escrowed specific revocation-signature principle; `design/PRECOMMITTED-RECOVERY.md` exact-object plan | Executable fixtures, formal model, privacy/usability review | medium | attempted |
