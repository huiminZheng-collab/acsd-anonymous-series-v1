...
def run(*args):
    return subprocess.run(
        ...
        text=True,
        encoding="utf-8",
        # Some external Windows tools localize stderr in the active ANSI code
        # page.  Tests parse ACSD's UTF-8 stdout; replacement decoding keeps an
        # unrelated localized diagnostic from killing subprocess reader threads.
        errors="replace",
    )
