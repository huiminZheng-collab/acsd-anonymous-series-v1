...
## Historical post-v3.3 work record

The frozen v3.3.0-rc1 candidate remains unchanged. This section records the
post-v3.3 source work that led to v4.0.0-rc1; its package/check counts are
historical rather than claims about the v4 candidate. An executable submission-lifecycle experiment
...
The resulting v4 candidate implements a minimal precommitted recovery path.
...
The earlier recovery iteration produced a 299-file evidence package that
passed all 25 artifact-mode checks. Its source rebuild was byte-for-byte
identical; v4 has its own current acceptance report and package manifest.
