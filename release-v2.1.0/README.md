...
- a Lean 4.33.1 build with 16 theorems and no `sorry`/`admit`.
...
- `release-v2.1.0/`: deterministic candidate release tree. The earlier
  `release-v2.0.0/` is retained rather than overwritten.

Build and verify the candidate release with:

```text
python build_release.py
python verify_release.py release-v2.1.0
```
