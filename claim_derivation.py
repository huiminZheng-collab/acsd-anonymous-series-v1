...
class ClaimKind(str, Enum):
    ...
    AUTHORIZED_TARGET_APPROVAL = "AUTHORIZED_TARGET_APPROVAL"
...
SUBJECT_TYPES = {
    ...
    EvidenceKind.AUTHORIZED_APPROVAL: ApprovalTargetSubject,
...
GRANTS = {
    ...
    EvidenceKind.AUTHORIZED_APPROVAL: frozenset({
...
WIRE_TO_CLAIM = {
    ...
    "AUTHORIZED_TARGET_APPROVAL": ClaimKind.AUTHORIZED_TARGET_APPROVAL,
...
class Claim:
    ...
    def __post_init__(self) -> None:
        ...
        expected = {
            ...
            ClaimKind.AUTHORIZED_TARGET_APPROVAL: ApprovalTargetSubject,
