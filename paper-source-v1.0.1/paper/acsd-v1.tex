...
Lean theorems in the abstract core & 53, no axiom dependency \\
\bottomrule
\end{tabular}
\end{table}
...
The Lean development models selected acceptance contracts. In particular, it proves that accepted citation witnesses equal an abstract scanner result, that the published reference list is the target projection of those witnesses, and that an offset mismatch or omitted token precludes acceptance. It also proves a rank-based acyclic commitment skeleton. These are proofs about the specified abstract verifier. They do not prove that the Python or Node parser implements the abstract scanner, nor do they prove cryptographic security of the underlying algorithms.
...
\bibitem{scitt}
H. Birkholz et al. \emph{An Architecture for Trustworthy and Transparent Digital Supply Chains}. RFC 9943, 2024. \url{https://www.rfc-editor.org/rfc/rfc9943.html}
