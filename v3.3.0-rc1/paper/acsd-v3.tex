...
\begin{enumerate}
  ...
  \item an executable prototype with one-command release, revision, and
        unblinding paths, a cross-work key-linkability audit, independent COSE
        verification, adversarial RFC~3161 checks, generated differential
        testing, a controlled adjacent-signature comparison, and a production
        appraisal transcript checked by both the executable and the Lean
        composition model.
\end{enumerate}
...
\texttt{finalize}, and \texttt{verify}. Lineage uses \texttt{authorize} and
\texttt{revise}; a separate \texttt{compare-successors} command detects
...
Python unit tests & 163 passed; 3 environment-dependent tests skipped locally \\
