...
FILES = (
    ...
    "approval_delegation_adapter.py",
    "approval_exchange.py",
    "appraisal_transcript.py",
    "artifact_io.py",
    ...
    "STATUS.md",
    "TEST-PLAN.md",
    "V4-ACCEPTANCE-REPORT.md",
    "V4-RC2-ACCEPTANCE-REPORT.md",
    "test_key_protection.py",
    "test_cli.py",
    "test_cli_output.py",
    "test_cli_signing.py",
    "test_approval_set.py",
    "test_approval_delegation.py",
    "test_approval_exchange.py",
    "test_appraisal_transcript.py",
    "test_adapter_facades.py",
    ...
    "design/ADJACENT-BASELINE-EVALUATION.md",
    "design/COMPARATIVE-EVALUATION.md",
    "design/COMPARISON-PROTOCOL.md",
    "design/CLI-PRODUCTIZATION-AUDIT.md",
    "design/NEWTON-SEALED-DISCOVERY.md",
    "design/V5-ROUTE-AUDIT.md",
    "design/comparative_evaluation.py",
    "design/timestamp_comparison.py",
    "design/comparison-run-20260915-b/results.json",
    "design/comparison-run-20260915-b/timestamp-results.json",
    "design/ATTACK-MISUSE.md",
    "design/APPRAISAL-TRANSCRIPT-V1.md",
    "design/CANONICAL-SPEC.md",
    "design/CLI-SPEC.md",
    "design/CLI-TEST-MATRIX.md",
    "design/CROSS-PAPER-ISOLATION.md",
    "design/DELEGATED-APPROVAL.md",
    "design/APPROVAL-EXCHANGE.md",
    "design/IMPLEMENTATION-NOTES.md",
    "design/KEY-PROTECTION.md",
    "design/GENERALIZATION-GATE.md",
    "design/LINEAGE-VERIFICATION-CERTIFICATE-V1.md",
    "design/MANUSCRIPT-SCOPE-AUDIT.md",
    "design/MULTI-AUTHOR-UNBLINDING.md",
    "design/PRECOMMITTED-RECOVERY.md",
    "design/RESEARCH-BACKLOG.md",
    "design/scripted_role_evaluation.py",
    "design/SECURITY-ROUTE-LEDGER.md",
    "design/SUBMISSION-LIFECYCLE.md",
    "design/SUBMISSION-LINK.md",
    ...
    "design/adjacent_baseline_report.json",
    "design/adjacent_baseline_runner.py",
    ...
    "design/lineage_verification_certificate.cjs",
    "design/lineage_verification_certificate_diff.py",
    ...
    "design/lean_lineage_transcript_diff.py",
    "design/lean_appraisal_transcript_diff.py",
    "design/lean_rats_transcript_diff.py",
    "design/rats_appraisal_transcript.py",
    "design/lineage_verification_certificate_demo.json",
    "design/lean_transcript_diff.py",
    "design/verification_certificate_demo.json",
    "design/verification_certificate_demo_v2.json",
    "design/verification_certificate_demo_v3.json",
    "design/acquire_rfc3161_fixture.py",
    "design/rfc3161-approval-set-fixture/request.tsq",
    "design/rfc3161-approval-set-fixture/response.tsr",
    "design/rfc3161-approval-set-fixture/tsa-cert.der",
    "design/rfc3161-approval-set-fixture/report.json",
    "demo/release.json",
    "formal/ACSD.lean",
    "formal/AxiomAudit.lean",
    "formal/ACSD/Core.lean",
    "formal/ACSD/PEC.lean",
    "formal/ACSD/GenericAppraisal.lean",
    "formal/ACSD/SubjectBoundEvidence.lean",
    "formal/ACSD/StrictJson.lean",
    "formal/ACSD/RatsTranscriptJson.lean",
    "formal/ACSD/RatsAppraisal.lean",
    "formal/ACSD/Lineage.lean",
    "formal/ACSD/ScopedClaims.lean",
    "formal/ACSD/SubmissionLink.lean",
    "formal/ACSD/DelegatedApproval.lean",
    "formal/ACSD/Appraisal.lean",
    "formal/ACSD/Transcript.lean",
    "formal/ACSD/LineageTranscript.lean",
    "formal/ACSD/TranscriptJson.lean",
    "formal/ACSD/AppraisalTranscriptJson.lean",
    "formal/TranscriptCli.lean",
    "formal/RatsTranscriptCli.lean",
    "formal/lake-manifest.json",
    "formal/lakefile.toml",
    "formal/lean-toolchain",
    "paper/acsd-v4.tex",
    "paper/acsd-acsac.tex",
    "paper/architecture.tikz",
    "paper/build/acsd-v4.pdf",
)
